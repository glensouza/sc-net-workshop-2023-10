...
namespace Employee.Function.OutputBinding
{
    public class AddProductWithMultiplePrimaryColumnsAndIdentity
    {
        ...
        [OpenApiParameter(name: "externalId", In = ParameterLocation.Query, Required = true, Type = typeof(string), Description = "The **ExternalId** parameter")]
        [OpenApiParameter(name: "cost", In = ParameterLocation.Query, Required = true, Type = typeof(string), Description = "The **Cost** parameter")]
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "application/json", bodyType: typeof(MultiplePrimaryKeyProductWithoutId), Description = "The OK response")]
